...
var fail = [
    ...
    "You can do it! Just practice many times!",
    "Don't be disappointed. Failure is the mother of success. When you fail, that's when you will learn your mistakes and be better!",
